    ...
    <div class="shadow-bar">
      <div class="floor1">
          <div class="logo">
              ...
              <span class="title">校园地图后台管理系统</span>
          </div>
      </div>
    </div>
    <el-form ref="loginForm" :model="loginForm" :rules="loginRules" class="login-form">
      <!-- <h3 class="title">山东大学校园地图后台管理系统</h3> -->
      ...
      <el-form-item style="width:100%;">
        <el-button
          :loading="loading"
          size="medium"
          style="width:100%;background-color:#a50001"
          @click.native.prevent="handleLogin"
        >
          <span style="color:#fff" v-if="!loading">登 录</span>
          <span style="color:#fff" v-else>登 录 中...</span>
        </el-button>
